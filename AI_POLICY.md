...
**This Policy has been copied from [here](https://github.com/ghostty-org/ghostty/blob/main/AI_POLICY.md) and slightly modified to use sentry-clj as the subject and make it less first-person voice and more third-person voice.**

The sentry-clj project has strict rules for AI usage:
...
These rules apply only to outside contributions to sentry-clj. Maintainers
...
Please remember that sentry-clj is maintained by humans.
...
Many maintainers embrace AI tools as a productive tool in their workflow. As a
project, we welcome AI as a tool!
...
This section is designed to be transparent about the project's usage with
regards to AI for people who may disagree with it, and to address the
misconception that this policy is anti-AI in nature.
